...
const features = [
  {
    ...
    body:
      'Unique, secure application links per job listing. Candidates upload resumes as PDF directly.',
  },
  {
    number: '02',
      ...
      <div className="mx-auto max-w-site px-6 lg:px-8">
        ...
        <div className="mt-14 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((feature) => (
            ...
            >
              <span className="font-sans text-5xl font-bold text-plum">{feature.number}</span>
